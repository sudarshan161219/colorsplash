...
const data = [
  ...
  const videoData = [
    { name: v1, value: 'https://res.cloudinary.com/dcjzplmer/video/upload/v1700635745/v1_gptpjt.mp4' },
    { name: v2, value: 'https://res.cloudinary.com/dcjzplmer/video/upload/v1700635726/v2_hqgm94.mp4' },
    { name: v3, value: 'https://res.cloudinary.com/dcjzplmer/video/upload/v1700635729/v6_u1muqz.mp4' },
    { name: v4, value: 'https://res.cloudinary.com/dcjzplmer/video/upload/v1700635744/v3_zoluif.mp4' },
    { name: v5, value: 'https://res.cloudinary.com/dcjzplmer/video/upload/v1700635751/v5_b4b3ja.mp4' },
    { name: v6, value: 'https://res.cloudinary.com/dcjzplmer/video/upload/v1700635753/v4_vhzs2r.mp4' },
  ]
